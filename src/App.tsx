...
const SIDE_QUESTS = [
  { id: 1, title: "Sipan Ply & Vineer", category: "KILLHOUSE MUSIC" },
  { id: 2, title: "Policybazaar Marks", category: "KILLHOUSE MUSIC" },
...
export default function App() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-black text-[#d1d1d1] font-sans overflow-x-hidden">
      <SpeederLoader isLoading={isPageLoading} />
      <motion.div
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 transition-timing-[cubic-bezier(0.23,1,0.32,1)] ${
        scrolled ? "py-4 px-4 sm:px-8 bg-black/40 backdrop-blur-3xl border-b border-white/5" : "py-6 px-4 sm:px-8"
      } flex items-center`}>
        <div className="flex-1 flex justify-start items-center gap-2 sm:gap-3">
          <motion.a 
            href="#home"
        ...
        <div className="flex-1 flex justify-end gap-4 sm:gap-12 items-center">
          ...
          <motion.button 
            ...
            className="flex items-center gap-1.5 sm:gap-3 text-[10px] font-bold uppercase tracking-[0.2em] opacity-80 hover:opacity-100 transition-opacity"
          >
            <Menu size={18} />
        ...
        <div className="w-full max-w-screen-2xl text-center">
          ...
          <div className="mb-8">
            <RevealText 
              ...
              className="text-4xl sm:text-6xl md:text-7xl lg:text-[110px] xl:text-[140px] font-sans font-black leading-[0.9] tracking-tighter uppercase text-white"
              delay={0.2}
              speed={1.2}
              highlightIndices={[0]}
              noWrap={true}
          ...
          >
            <p className="text-sm leading-relaxed opacity-60">
              Producer and Sound Designer exploring the intersection of Indian music and modern production.
            </p>
          </motion.div>
        </div>
      ...
      <motion.section 
        ...
        id="work" 
        className="py-24 px-4 sm:px-8 lg:px-12 relative z-10"
      >
              ...
              >
                <div className={`glass-card p-4 rounded-xl h-full transition-all duration-500 hover:bg-white/[0.05] border shadow-2xl ${
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden rounded-lg mb-6 ring-1 ring-white/5">
                    ...
                    <div className="absolute inset-0 z-10 pointer-events-none bg-gradient-to-tr from-white/10 via-transparent to-white/5 opacity-30" />
                    <motion.img 
                      whileHover={{ scale: 1.05 }}
                  ...
                  <div className="space-y-1 px-1">
                    ...
                    <p className="text-[10px] opacity-30 uppercase tracking-[0.15em] font-semibold">{project.category}</p>
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        id="sounds" 
        className="relative pt-32 pb-16 px-8 sm:px-16 lg:px-32 overflow-hidden border-t"
      >
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6 mb-8 relative">
              <Visualizer isPlaying={isPlaying} style={hoveredVizStyle || vizStyle} color={hoveredVizColor || vizColor} {...aiVisuals} />
      ...
      {/* Footer */}
      <footer id="contact" className="py-16 px-8 sm:px-16 lg:px-32 border-t border-white/5 relative z-10 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 mb-24">
          <motion.div
          ...
          >
            <div className="mb-8">
              <RevealText 
                ...
                className="text-3xl sm:text-5xl font-display font-light text-white leading-tight tracking-tighter justify-start text-left"
                delay={0.2}
              />
            </div>
            <div className="flex gap-4">
              <motion.a 
                ...
                href="https://wa.me/918454063677" 
                target="_blank"
                rel="noopener noreferrer"
                className="px-10 py-5 bg-white text-black font-bold uppercase tracking-[0.3em] text-[10px] hover:bg-white transition-all rounded-full block border border-white text-center relative overflow-hidden group/btn"
              >
                <motion.span 
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-6 text-[11px] uppercase tracking-[0.15em] font-medium">
                {[
                  { name: 'Instagram', href: 'https://www.instagram.com/killhouse_music' },
                  { name: 'YouTube', href: 'https://www.youtube.com/@killhousemusic' },
                  { name: 'Spotify', href: 'https://open.spotify.com/artist/5B3OloVMmMcUYVAmNgQ4Uk' }
                ].map((network, i) => (
                  <motion.a 
                    key={network.name}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8 pt-16 border-t border-white/5">
          <p className="text-[9px] uppercase tracking-[0.4em] opacity-30">© KILLHOUSE MUSIC — All Creative Rights Reserved</p>
        </div>
      </footer>
    </div>
  );
